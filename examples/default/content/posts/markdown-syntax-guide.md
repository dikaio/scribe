...
This article offers a sample of basic Markdown syntax that can be used in Scribe content files.
...
Tables aren't part of the core Markdown spec, but they are supported in many Markdown processors.
